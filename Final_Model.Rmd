...
SEIR <- function(time, state, parms) {
  ...
  # 
    with(as.list(c(state, parms)),{
        ...
        # make an equatioon for rho based on dR which serves as a measure of # of cases
        rho<- dR * (1/shelter_response)
...
parms <- c(alpha = 0.2, beta = 2, gamma = 1, shelter_response = 0.1) # assuming a stay at home order that reduces social contact by 20%
...
weather_coeff = 100 # coefficient of weather on averge miles driven a day in CA
