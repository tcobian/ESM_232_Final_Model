...
SEIR <- function(time, state, parms) {
  ...
  # 
    with(as.list(c(state, parms)),{
        ...
        # make an equation for rho based on dR which serves as a measure of # of cases
        rho<- 1 - dR
...
init <- c(S =1-.001, E =.001, I = 0, R = 0, rho = 0) # assuming 0.1% of the population has been infected
...
rho_vector<-seq(0.4, 0.9, by = 0.002777778)# vector of shelter in place strength
length(rho_vector)

out$shelter_strength<- rho_vector # add shelter strength to data
