...
rho_vector<-seq(0.4, 0.9, by = ((0.9-0.4)/length(out$time)))# vector of shelter in place strength
length(rho_vector)
...
for (i in length(out$S)){
  out$miles_driven = avg_mile_day + weather_coeff * (out$temp - mean(out$temp)) - shelter_coeff * parms[4]
}
