...
final_model<- function(b, s, i, k, shelter_strength, avg_mile_day = 974219178, mean_temp, mile_emission = 0.411){
  ...
  covid<- data.frame(day = seq(1:365), infected_no_shelter = NA, infected_shelter = NA, miles_driven = NA, ghg = NA)
...
parms = list(b = 3, s = 39510000, i = 100, k = 5, shelter_strength = 0.5, mean_temp = 2)

time = seq(from = 1, to = 365, by = 1)

initial_infect = 100

result = ode(y = initial_infect, times = time, func = final_model, parms = parms)
